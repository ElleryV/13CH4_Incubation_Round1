...
Plot <- ggplot(data = subset(summary_fig, soil_type == "Unamended"), 
  ...
  theme_bw() +
  geom_errorbar(data = subset(summary_fig, soil_type == "Unamended"), 
...
ggsave(Plot, filename = "figures/isotopes/pHwetcontrol_UNonly.png", width = 8, height = 5)
